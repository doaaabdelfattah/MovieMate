...
cursor: pointer;
transition: background-color 0.5s linear, color 0.5s linear, box-shadow 0.3s ease-in-out;
&.active svg {
    color: red;
  }
...
const AddToFavButton: React.FC<AddToFavButtonProps> = ({movieId, type="primary"}) => {
  ...
  return (
    <StyledButton className="group" onClick={()=>updateFavorites(movieId)} $type={type}>
